<template>
  <div class="login-card">
    <!-- Version -->
    <div class="text-right mr-3 text-disable-100">
      <p class="kanit-600-16">v.0.1.16</p>
    </div>
    ...
    <div class="grid justify-items-center">
      <!-- Logo Image -->
      <div>
        <img src="@/assets/images/asap-logo.svg" alt="ASAP Logo" />
      </div>
      ...
      <!-- Text line one -->
      <div class="text-disable kanit-600-16 mt-3">
        <p>ระบบช่วยจัดการแผนการเรียนการสอนประจำหลักสูตร</p>
      </div>
